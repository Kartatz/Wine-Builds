...
CROSS_COMPILE_TRIPLET='mips64el-unknown-linux-gnuabi64'
CROSS_COMPILE_SYSTEM='linux'
CROSS_COMPILE_ARCHITECTURE='mips64el'

CC="${OBGGCC_HOME}/bin/${CROSS_COMPILE_TRIPLET}-gcc"
CXX="${OBGGCC_HOME}/bin/${CROSS_COMPILE_TRIPLET}-g++"
